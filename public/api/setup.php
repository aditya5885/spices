...
$stmtSet = $conn->prepare("INSERT INTO settings (key_name, value_text) VALUES (?, ?) ON DUPLICATE KEY UPDATE value_text = IF(key_name = 'razorpay_key_id' OR key_name = 'razorpay_key_secret', VALUES(value_text), value_text)");
